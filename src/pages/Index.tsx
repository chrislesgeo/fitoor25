...
const Index = () => {
  ...
  {/* Main content (raised above building) */}
  <div className="relative z-30 flex flex-col items-center justify-center min-h-screen px-4 pb-20 pointer-events-auto">
        {/* Title section */}
        ...
        <div className="mb-12 md:mb-16">
          <a
            href={"/Fitoor%20'25-Schedule.pdf"}
            target="_blank"
    ...
    {/* Building at the bottom (visual only) */}
  <div className="fixed bottom-0 left-0 right-0 z-0 pointer-events-none select-none">
        <div className="relative">
          <img 
            src={buildingImage} 
            alt="University Building" 
            className="w-full h-auto object-cover object-top pixel-borders pointer-events-none select-none"
            style={{ 
              maxHeight: '50vh',
              imageRendering: 'pixelated'
            }}
          ...
          {/* Removed interactive overlay from building layer */}
        </div>
      </div>
      {/* Floating Instagram link, independent layer */}
      <div className="fixed bottom-4 left-6 z-40 pointer-events-none">
        <div className="text-white pointer-events-auto">
          ...
          >
            ...
            <span className="text-sm md:text-base underline underline-offset-2">fitoor.plaksha</span>
          </a>
          <p className="text-xs md:text-sm">at Plaksha University.</p>
        </div>
      </div>
    </div>
  );
